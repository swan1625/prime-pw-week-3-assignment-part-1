...
let favoriteFoods = ['lake trout', 'morel mushrooms', 'pasta', 'chicken wild rice soup'];
...
console.log('Number of favoriteFoods:', favoriteFoods.length);
...
console.log('Added a food to end,', favoriteFoods);
...
console.log('The animals are now', favoriteFoods);
